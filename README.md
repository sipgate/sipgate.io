...
```sh
curl -X POST --data "event=newCall&from=492111234567&to=4915791234567&direction=in&callId=123456&user[]=Alice&user[]=Bob&userId[]=w0&userId[]=w1&" http://localhost:3000
```
...
```sh
curl -X POST --data "event=answer&callId=123456&user=John+Doe&userId=w0&from=492111234567&to=4915791234567&direction=in&answeringNumber=21199999999" http://localhost:3000
```
